  ...
  ngOnInit() {
    this.route.paramMap.subscribe((paramMap: ParamMap) => {
      if (paramMap.has('taskId')) {
        ...
        this.taskService.getTask(parseInt(this.taskId)).subscribe(taskData => {
          this.taskToEdit =
          new Task(taskData._id, taskData.parentId, taskData.taskName, taskData.startDate, taskData.endDate, taskData.priority, taskData.taskId);
        });
